...
- (void)updatePosition {
    ...
    if(string) {
        NSDictionary *attributesDictionary = @{NSFontAttributeName: [UIFont systemFontOfSize:self.stringLabel.font.pointSize]};
        CGSize stringSize = [string boundingRectWithSize:CGSizeMake(200, 300) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributesDictionary context:nil].size;
