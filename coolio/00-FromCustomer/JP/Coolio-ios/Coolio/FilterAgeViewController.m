...
#import "FilterAgeViewController.h"

@interface FilterAgeViewController ()

@end

@implementation FilterAgeViewController
@synthesize cell0;
@synthesize cell1;
@synthesize t1;
@synthesize seg1;
...
- (void)viewDidLoad
{
    ...
    self.t1.text = [NSString stringWithFormat:@"%d", [account getAgeFilter]];
...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    [account setAgeFilter:value];

    if(self.seg1.selectedSegmentIndex == 0){
        [account setAgeFilterHiLow:YES];
    }else{
        [account setAgeFilterHiLow:NO];
    }
}
