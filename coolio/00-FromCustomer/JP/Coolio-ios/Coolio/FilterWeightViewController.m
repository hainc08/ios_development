...
#import "FilterWeightViewController.h"

@interface FilterWeightViewController ()

@end

@implementation FilterWeightViewController
@synthesize cell0;
@synthesize cell1;
@synthesize t1;
@synthesize seg1;
...
- (void)viewDidLoad
{
    ...
    BOOL hiLow =  [account getWeightFilterHiLow];
    if(hiLow == YES){
        self.seg1.selectedSegmentIndex = 0;
    }else{
        self.seg1.selectedSegmentIndex = 1;
    }
    self.t1.text = [NSString stringWithFormat:@"%d", [account getWeightFilter]];
...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    [account setWeightFilter:value];
    
    if(self.seg1.selectedSegmentIndex == 0){
        [account setWeightFilterHiLow:YES];
    }else{
        [account setWeightFilterHiLow:NO];
    }
}
