...
@interface FrendsViewController ()
...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(toNotifyTheGetMyFriend:) name:@"ToNotifyTheGetMyFriend" object:nil];
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [friendCollections count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary* userDict = [friendCollections[indexPath.row] mutableCopy];
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"FriendToAccountDetail"]) {
...
{
    friendCollections = [[notification object] mutableCopy];
    friendCollections = [self sortArrayLastLoginTime:friendCollections];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([segue.identifier isEqualToString:@"FriendToAccountDetail"]) {
        ...
        NSDictionary* userInfoDict = [friendCollections[idxPath.row] mutableCopy];
