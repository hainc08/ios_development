...
public class InformationAdapter extends ArrayAdapter<ObjMember> {
	private final Context context;
	private final ArrayList<ObjMember> list_item;
	private LayoutInflater inflater;
	
	public InformationAdapter(Context context,  ArrayList<ObjMember> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final ObjMember item = list_item.get(position);
			rowView = inflater.inflate(R.layout.information_item, null);
